...
**[Awesome Books - a complete website with navigation]** is the third project in the Module 2. In this project I completed the Awesome Books site.
...
```
$ git clone https://github.com/Edgahkipkemoi/Awesome-book-app.git
```
